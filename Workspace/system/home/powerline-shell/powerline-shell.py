...
def get_powerline():
    ...
    return Powerline(args, get_valid_cwd())


if __name__ == "__main__":
    powerline = get_powerline()
...
def add_cwd_segment(powerline):
    ...
    powerline.append(' \W ', Color.PATH_FG, Color.PATH_BG, None, None)
...
def add_git_segment(powerline):
    ...
    if branch_info:
        ...
        branch = u'{} {}'.format(RepoStats.symbols['branch'], branch_info['local'])
    else:
